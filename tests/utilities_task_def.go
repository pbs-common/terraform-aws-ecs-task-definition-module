...
func testTaskDef(t *testing.T, variant string) {
	...
	switch variant {
	case "basic":
		expectedContainerDefinitions = fmt.Sprintf("[{\"environment\":[{\"name\":\"SSM_PATH\",\"value\":\"/sharedtools/%s/\"}],\"essential\":true,\"image\":\"nginx:alpine\",\"logConfiguration\":{\"logDriver\":\"awslogs\",\"options\":{\"awslogs-group\":\"%s\",\"awslogs-region\":\"%s\",\"awslogs-stream-prefix\":\"app\",\"mode\":\"non-blocking\"}},\"name\":\"app\",\"portMappings\":[{\"containerPort\":80}]}]", expectedName, logGroupName, region)
	case "cmd":
	...
	case "efs":
		...
		expectedContainerDefinitions = fmt.Sprintf("[{\"environment\":[{\"name\":\"SSM_PATH\",\"value\":\"/sharedtools/%s/\"}],\"essential\":true,\"image\":\"nginx:alpine\",\"logConfiguration\":{\"logDriver\":\"awslogs\",\"options\":{\"awslogs-group\":\"%s\",\"awslogs-region\":\"%s\",\"awslogs-stream-prefix\":\"app\",\"mode\":\"non-blocking\"}},\"mountPoints\":[{\"containerPath\":\"/mnt/efs1\",\"sourceVolume\":\"%s\"},{\"containerPath\":\"/mnt/efs2\",\"sourceVolume\":\"%s\"}],\"name\":\"app\",\"portMappings\":[{\"containerPort\":80}]}]", expectedName, logGroupName, region, efs1ID, efs2ID)
	case "newrelic":
	...
	case "virtual-gateway":
		expectedContainerDefinitions = fmt.Sprintf("[{\"environment\":[{\"name\":\"APPMESH_RESOURCE_ARN\",\"value\":\"arn:aws:appmesh:%s:%s:mesh/mesh_name/virtualGateway/virtual_gateway\"},{\"name\":\"ENABLE_ENVOY_XRAY_TRACING\",\"value\":\"1\"}],\"essential\":true,\"healthCheck\":{\"command\":[\"CMD-SHELL\",\"curl -s http://localhost:9901/server_info | grep state | grep -q LIVE\"],\"interval\":5,\"retries\":3,\"startPeriod\":10,\"timeout\":2},\"image\":\"public.ecr.aws/appmesh/aws-appmesh-envoy:v1.23.1.0-prod\",\"logConfiguration\":{\"logDriver\":\"awslogs\",\"options\":{\"awslogs-group\":\"%s\",\"awslogs-region\":\"%s\",\"awslogs-stream-prefix\":\"envoy\",\"mode\":\"non-blocking\"}},\"name\":\"envoy\",\"portMappings\":[{\"containerPort\":80,\"protocol\":\"tcp\"}],\"user\":\"1337\"},{\"cpu\":32,\"essential\":true,\"image\":\"amazon/aws-xray-daemon\",\"logConfiguration\":{\"logDriver\":\"awslogs\",\"options\":{\"awslogs-group\":\"%s\",\"awslogs-region\":\"%s\",\"awslogs-stream-prefix\":\"xray\"}},\"memoryReservation\":256,\"name\":\"xray-daemon\",\"portMappings\":[{\"containerPort\":2000,\"protocol\":\"udp\"}],\"user\":\"1337\"}]", region, accountID, logGroupName, region, logGroupName, region)
	case "virtual-node":
		expectedContainerDefinitions = fmt.Sprintf("[{\"dependsOn\":[{\"condition\":\"HEALTHY\",\"containerName\":\"envoy\"}],\"environment\":[{\"name\":\"SSM_PATH\",\"value\":\"/sharedtools/%s/\"}],\"essential\":true,\"image\":\"nginx:alpine\",\"logConfiguration\":{\"logDriver\":\"awslogs\",\"options\":{\"awslogs-group\":\"%s\",\"awslogs-region\":\"%s\",\"awslogs-stream-prefix\":\"app\",\"mode\":\"non-blocking\"}},\"name\":\"app\",\"portMappings\":[{\"containerPort\":80}]},{\"environment\":[{\"name\":\"APPMESH_RESOURCE_ARN\",\"value\":\"arn:aws:appmesh:%s:%s:mesh/mesh_name/virtualNode/virtual_node\"},{\"name\":\"ENABLE_ENVOY_XRAY_TRACING\",\"value\":\"1\"}],\"essential\":true,\"healthCheck\":{\"command\":[\"CMD-SHELL\",\"curl -s http://localhost:9901/server_info | grep state | grep -q LIVE\"],\"interval\":5,\"retries\":3,\"startPeriod\":10,\"timeout\":2},\"image\":\"public.ecr.aws/appmesh/aws-appmesh-envoy:v1.23.1.0-prod\",\"logConfiguration\":{\"logDriver\":\"awslogs\",\"options\":{\"awslogs-group\":\"%s\",\"awslogs-region\":\"%s\",\"awslogs-stream-prefix\":\"proxy\"}},\"memory\":500,\"name\":\"envoy\",\"user\":\"1337\"},{\"cpu\":32,\"essential\":true,\"image\":\"amazon/aws-xray-daemon\",\"logConfiguration\":{\"logDriver\":\"awslogs\",\"options\":{\"awslogs-group\":\"%s\",\"awslogs-region\":\"%s\",\"awslogs-stream-prefix\":\"xray\"}},\"memoryReservation\":256,\"name\":\"xray-daemon\",\"portMappings\":[{\"containerPort\":2000,\"protocol\":\"udp\"}],\"user\":\"1337\"}]", expectedName, logGroupName, region, region, accountID, logGroupName, region, logGroupName, region)
	case "vnode-newrelic":
		expectedContainerDefinitions = fmt.Sprintf("[{\"dependsOn\":[{\"condition\":\"HEALTHY\",\"containerName\":\"envoy\"}],\"environment\":[{\"name\":\"SSM_PATH\",\"value\":\"/sharedtools/%[1]s/\"}],\"essential\":true,\"image\":\"nginx:alpine\",\"logConfiguration\":{\"logDriver\":\"awsfirelens\",\"options\":{\"Name\":\"newrelic\"},\"secretOptions\":[{\"name\":\"apiKey\",\"valueFrom\":\"arn:aws:secretsmanager:*:*:secret:fake-newrelic-secret-arn\"}]},\"name\":\"app\",\"portMappings\":[{\"containerPort\":80}]},{\"essential\":true,\"firelensConfiguration\":{\"options\":{\"enable-ecs-log-metadata\":\"true\"},\"type\":\"fluentbit\"},\"image\":\"533243300146.dkr.ecr.us-east-1.amazonaws.com/newrelic/logging-firelens-fluentbit\",\"logConfiguration\":{\"logDriver\":\"awslogs\",\"options\":{\"awslogs-group\":\"%[2]s\",\"awslogs-region\":\"%[3]s\",\"awslogs-stream-prefix\":\"firelens\"}},\"name\":\"firelens\"},{\"environment\":[{\"name\":\"APPMESH_RESOURCE_ARN\",\"value\":\"arn:aws:appmesh:%[3]s:%[4]s:mesh/mesh_name/virtualNode/virtual_node\"},{\"name\":\"ENABLE_ENVOY_XRAY_TRACING\",\"value\":\"1\"}],\"essential\":true,\"healthCheck\":{\"command\":[\"CMD-SHELL\",\"curl -s http://localhost:9901/server_info | grep state | grep -q LIVE\"],\"interval\":5,\"retries\":3,\"startPeriod\":10,\"timeout\":2},\"image\":\"public.ecr.aws/appmesh/aws-appmesh-envoy:v1.23.1.0-prod\",\"logConfiguration\":{\"logDriver\":\"awslogs\",\"options\":{\"awslogs-group\":\"%[2]s\",\"awslogs-region\":\"%[3]s\",\"awslogs-stream-prefix\":\"proxy\"}},\"memory\":500,\"name\":\"envoy\",\"user\":\"1337\"},{\"cpu\":32,\"essential\":true,\"image\":\"amazon/aws-xray-daemon\",\"logConfiguration\":{\"logDriver\":\"awslogs\",\"options\":{\"awslogs-group\":\"%[2]s\",\"awslogs-region\":\"%[3]s\",\"awslogs-stream-prefix\":\"xray\"}},\"memoryReservation\":256,\"name\":\"xray-daemon\",\"portMappings\":[{\"containerPort\":2000,\"protocol\":\"udp\"}],\"user\":\"1337\"}]", expectedName, logGroupName, region, accountID)
	default:
